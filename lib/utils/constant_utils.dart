...
const String prefLanguage = 'LANGAUGE';
const String prefApiToken = 'APITOKEN';
const String categoryID = 'categoryID';
const String subcategoryID = 'subcategoryID';


/* CONSTANT DATA */
const String rs = '\u20B9';
const String loginWithMobile = 'Mobile';
...
BorderRadius circular24 = const BorderRadius.all(Radius.circular(24));


/*Spaceing*/

const double axisSpacing = 16;